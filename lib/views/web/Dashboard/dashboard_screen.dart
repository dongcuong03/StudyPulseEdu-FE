                  ...
                  LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      final double cardWidth =
                          (maxWidth - 40) / 2; // trừ spacing

                      return Wrap(
                        spacing:
                            40, // khoảng cách giữa các card theo chiều ngang
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Container(
                              ...
                              child: ClassPerTeacherChart(
                                data: dashboard.teacherClassCounts,
                              ),
                            ),
                          ),
                          SizedBox(
                            ...
                            child: Container(
                              ...
                              child: StudentDistributionChart(
                                data: dashboard.classStudentCounts,
                              ),
                            ),
                          ),
                        ],
