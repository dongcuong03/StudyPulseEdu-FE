...
class _EditClassFormWidgetState extends ConsumerState<EditClassFormWidget>
    with HelperMixin {
  ...
  String? formatTime(String? time) {
    ...
    if (parts.length >= 2) {
      return '${parts[0]}:${parts[1]}'; // chỉ lấy giờ và phút
    }
    return time;
  }
    ...
    if (!isSelectedList.contains(true)) {
      ...
      if (isValidForm) {
        ...
        if (message != null) {
          ...
          widget.onClose();
          showSuccessToastWeb(context, "Sửa lớp học thành công");
        }
      }
    }
  }
