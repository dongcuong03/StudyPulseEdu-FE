...
class _ViewAcademicResultTeacherScreenState
    extends ConsumerState<ViewAcademicResultTeacherScreen> with HelperMixin {
  ...
  void _submit() async {
    await showConfirmDialogMobile(
        ...
        title: 'Thông báo',
        content:
            'Bạn có muốn lưu lại và gửi thông báo kết quả học tập đến phụ huynh?',
        icon: Icons.notifications,
        onConfirm: () async {
          showLoading(context, show: true);
          final errorMsg = await ref
              .read(
                  academicResultMobileTeacherViewModelProvider(widget.classId!)
                      .notifier)
