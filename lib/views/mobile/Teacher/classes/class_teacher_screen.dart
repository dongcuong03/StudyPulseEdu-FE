...
class _ClassTeacherScreenState extends ConsumerState<ClassTeacherScreen> with HelperMixin {
              ...
              return Card(
                ...
                child: Padding(
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      pushedName(context, RouteConstants.teacherViewClassRouteName, extra: classItem.id);
                    },
