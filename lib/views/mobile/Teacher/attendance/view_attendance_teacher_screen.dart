...
class ViewAttendanceTeacherScreen extends ConsumerStatefulWidget {
  final Account? account;
  final ClassRoom? classRoom;
  final DateTime? date;

  const ViewAttendanceTeacherScreen({
  ...
  @override
  ConsumerState createState() => _ViewAttendanceTeacherScreenState();
}

class _ViewAttendanceTeacherScreenState
    extends ConsumerState<ViewAttendanceTeacherScreen> with HelperMixin {
